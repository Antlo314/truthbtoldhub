                  ...
                  {mode === "signup" ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <button
                        type="button"
                        onClick={goToSignUp}
                        className="inline-flex items-center gap-2 px-6 py-2 bg-amber-800/30 hover:bg-amber-700/40 border border-amber-700/30 hover:border-amber-500/50 rounded-lg text-amber-300 hover:text-amber-200 transition-all duration-300"
                      >
