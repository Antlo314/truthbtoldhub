            ...
            {outfit === 'vest' ? (
                ...
                <>
                    <mesh position={[0, chestH * 0.35, 0]} castShadow scale={[1.08, 1, 1]}>
                        <capsuleGeometry args={[chestR, chestH * 0.4, 5, 12]} />
                        <Mat color={c.top} roughness={0.78} />
                    </mesh>
                    {/* sash */}
                ...
                <>
                    ...
                    <mesh position={[0, chestH * 0.55, chestR * 0.7]} castShadow>
                        ...
                        <Mat color={c.gold} roughness={0.4} metalness={0.45} />
                    </mesh>
                </>
        ...
        <group>
            ...
            {outfit === 'tunic' && (
                <mesh position={[0, -0.12, 0]} castShadow>
                    ...
                    <Mat color={c.topDeep} roughness={0.8} />
                </mesh>
            )}
            {/* belt */}
