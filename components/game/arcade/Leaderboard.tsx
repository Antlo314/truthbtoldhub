...
export default function Leaderboard({ rows, accent, loading, emptyLabel }: Props) {
    if (loading) {
            ...
            {rows.map((r) => (
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[9px] font-mono uppercase tracking-widest text-white/35">Lv {r.level} · {r.lines} lines</p>
                    </div>
