...
const WANTED = [
    { key: 'woodFloor', slugs: ['wood_floor_deck', 'wood_floor'] },
    { key: 'woodDark', slugs: ['dark_wood', 'wood_planks_dirt'] },
    { key: 'plaster', slugs: ['painted_plaster_wall', 'plastered_wall'] },
    ...
    { key: 'marble', slugs: ['marble_01', 'marble_0008'] },
            ...
            for (const [apiName, short] of MAPS) {
                ...
                const key =
                    apiName === 'Diffuse'
                        ...
                        : apiName;
                const node = files[key]?.['1k']?.jpg ?? files[key]?.['1k']?.png;
                if (!node?.url) {
